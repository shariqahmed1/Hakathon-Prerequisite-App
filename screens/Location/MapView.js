...
export default class App extends Component {
  ...
  static getDerivedStateFromProps(nextProps){
    return{
      coordinates:nextProps.navigation.state.params.coordinates,
      title:nextProps.navigation.state.params.name,
    }
  }

  componentDidMount() {
    const { title } = this.state;
    this.props.navigation.setParams({ myTitle: title })
  }
  ...
  render() {
    const { coordinates, showRoute } = this.state;
    return (
